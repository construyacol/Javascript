...
},{"./is-object":17,"./request-base":18,"./response-base":19,"./should-retry":20,"component-emitter":3}],17:[function(require,module,exports){
/**
...
},{"./update-events.js":23,"bel":1,"morphdom":10}],23:[function(require,module,exports){
module.exports = [
...
},{"./template":25,"page":13,"superagent":16}],25:[function(require,module,exports){
'use strict';
...
module.exports = function (pictures) {
	...
	pictures.map(function (pic) {
		agregaloVe = agregaloVe + '<div class="card">' + '<div id="nombre">' + pic.user.username + '</div>' + '<div class="card-image">' + '<img class="activator" src=' + pic.url + '>' + '</div>' + '<div class="card-content">' + '<a href="' + pic.user.username + '" class="card-title ">' + '<img src="' + pic.user.avatar + '" class="avatar">' + '<span class="username">' + pic.user.username + '</span>' + '</a>' + '<small class="right time">' + moment(pic.createdAt).fromNow() + '</small>' + '<div class="contecora" id="cora' + i + '">' + '<a class="left cora" id="like' + i + '" onclick="like(' + i + ',' + pic.likes + ');"><i class="fa fa-heart-o" aria-hidden="true"></i></a>' + '<a class="left cora" id="dislike' + i + '" onclick=dislike(' + i + ',' + pic.likes + ');><i class="fa fa-heart" aria-hidden="true"></i></a>' + '<span class="left likes">' + pic.likes + ' me gusta</span>' + '</div>' + '</div>' + '</div>';
		i++;
	});
...
},{"moment":9}],26:[function(require,module,exports){
'use strict';
...
},{"../layout/":30,"../picture-card":31,"yo-yo":22}],28:[function(require,module,exports){
'use strict';
...
},{"./feed":24,"./homepage":26,"./signin":32,"./signup/template":33,"./user-page":34,"page":13}],29:[function(require,module,exports){
'use strict';
...
module.exports = function pictureCard(pic) {
  ...
  function render(picture) {
    return yo(_templateObject, picture.url, picture.user.username, picture.user.avatar, picture.user.username, moment(picture.createdAt).fromNow(), like, dislike, picture.likes);
  }
...
},{"moment":9,"yo-yo":22}],32:[function(require,module,exports){
'use strict';
...
(0, _page2.default)('/:username', loadUser, function (ctx, next) {
	var content = $('#userPic');
	...
	content.append((0, _template2.default)(ctx.user));
});
...
},{"./template":35,"page":13,"superagent":16}],35:[function(require,module,exports){
'use strict';
